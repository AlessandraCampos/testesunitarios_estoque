...
public class BeerControllerTest {
    ...
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(beerController)
                ...
                .setViewResolvers((s, locale) -> new MappingJackson2JsonView())//visualização para json
                .build();
    }

    @Test// mock de chamadas post
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                ...
                .andExpect(status().isCreated())// status criado
                .andExpect(jsonPath("$.name", is(beerDTO.getName())))// beer's name
                .andExpect(jsonPath("$.brand", is(beerDTO.getBrand()))) // beer's brand
                .andExpect(jsonPath("$.type", is(beerDTO.getType().toString())));//beer's type
    }
    ...
    @Test
    void whenGETIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {// quando um nome é pesquisado com status 200
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenGETIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
        // given  nome de pesquisa nao encontrado erro 404
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(BEER_API_URL_PATH)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].name", is(beerDTO.getName()))) // traz a primeira posição da lista
    ...
    void whenDELETEIsCalledWithValidIdThenNoContentStatusIsReturned() throws Exception {
        // given-Exclui quando o Id da beer é válido
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
